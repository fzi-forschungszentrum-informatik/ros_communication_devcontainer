...
def start_relay_nodes(topics_list, remove_target_prefix='', topic_list_prefix=''):
...
if __name__ == "__main__":
    ...
    for topic_list_prefix in topic_list_prefixes:
        relays = relays + start_relay_nodes(all_topics_list, remove_target_prefix, topic_list_prefix)
