...
def start_relay_nodes(topics_list, target_prefix='', topic_list_prefix=''):
    prefixed_topics_list = [topic_list_prefix + topic for topic in topics_list]
    
    relays = []
    for topic in prefixed_topics_list:
        new_topic = f"{target_prefix}{topic}_sync"
...
if __name__ == "__main__":
    ...
    for topic_list_prefix in topic_list_prefixes:
        relays = relays + start_relay_nodes(all_topics_list, target_prefix, topic_list_prefix)
